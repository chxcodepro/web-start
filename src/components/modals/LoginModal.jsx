    ...
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl w-full max-w-sm shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-8 animate-fade-in-scale">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 bg-white hover:bg-gray-100 text-gray-900 rounded-xl font-bold transition shadow-lg flex items-center justify-center gap-2 disabled:opacity-50"
        >
          {loading ? (
