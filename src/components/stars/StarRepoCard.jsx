...
export default function StarRepoCard({ repo, groups = [], onUpdateRepo }) {
  ...
  return (
    <div className="group relative bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl transition-all duration-300 p-4 border border-white/20 hover:border-white/30">
      {/* 置顶按钮 */}
      <button
